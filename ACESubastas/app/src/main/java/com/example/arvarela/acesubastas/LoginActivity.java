...
public class LoginActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       /* final TextView tvNuevaPublicacion=(TextView) findViewById(R.id.tvNuevaPublicacion);

        tvNuevaPublicacion.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent registerIntent = new Intent(LoginActivity.this, RgisterCarActivity.class);
